...
?>
 	...
 	<!---->
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="col-md-12 form-group1 form-last">
              <label class="control-label">Upload service img :</label>
              <input type="file" placeholder="service img" name="service_img"  value="<?php echo $fetch->service_img;?>"><br>
              <img src="service_img/<?php echo $fetch->service_img;?>" alt="service Img" width="50px">
            </div>
            <div class="clearfix"> </div><br> 
