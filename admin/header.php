                    ...
                    <ul class=" nav_1">
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle dropdown-at" data-toggle="dropdown"><span
                                    class=" name-caret"><?php echo $_SESSION['name'];?><i class="caret"></i></span></a>
                        ...
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                <a href="#" class=" hvr-bounce-to-right"><i class="fa fa-indent nav_icon"></i> <span
                                        class="nav-label">Services</span><span class=""></span></a>
                            </li>

                            <li>
                                <a href="add_company" class=" hvr-bounce-to-right"> <i
                                        class="fa fa-user nav_icon"></i>Add Company</a>
                            </li>

                            <li>
                                <a href="add_model" class=" hvr-bounce-to-right"> <i class="fa fa-user nav_icon"></i>Add
                                    Model</a>
                            </li>

                            <li>
                                <a href="add_service" class=" hvr-bounce-to-right"> <i
                                        class="fa fa-user nav_icon"></i>Add service</a>
                            </li>

                            <li>
                                <a href="manage_company" class=" hvr-bounce-to-right"><i
                                        class="fa fa-user nav_icon"></i>Manage Company</a>
                            </li>

                            <li>
                                <a href="manage_model" class=" hvr-bounce-to-right"><i
                                        class="fa fa-user nav_icon"></i>Manage Model</a>
                            </li>

                            <li>
                                <a href="manage_service" class=" hvr-bounce-to-right"><i
                                        class="fa fa-user nav_icon"></i>Manage service</a>
                            </li>

                            <li>
                                <a href="view_customer" class=" hvr-bounce-to-right"><i
                                        class="fa fa-user nav_icon"></i> <span class="nav-label">View Customer</span>
                                </a>
                            </li>
