...
<h3 class="text-center pb-5 b-line" style="font-size: 1.575rem;padding-bottom: 1rem!important;">Please select Model</h3>
<br>
</div>
<?php
...
<div class="card" >
  <div class="card-body">
  <a href="model_services?view_model_services=<?php echo $m ->mod_id;?>" class="">
    <img class="card-img-top" src="../admin/model_img/<?php echo $m ->mod_img;?>" alt="Card image cap"><br>
	<br>
  <!-- model img name -->
  <h6><b><?php echo $m ->mod_name ;?></b></h6>
  </a>
  </div>
</div>
