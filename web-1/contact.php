...
<h3 class="mb-lg-4 mb-md-3 mb-sm-2 mb-2"><u>Contact US</u></h3>
	<!-- contact -->
            ...
            <h2 class="tittle mb-xl-5 mb-4 text-center">
					<span class="text-uppercase"></span></h2>
                    ...
                    <div class="col-lg-4 address-grid-w3l">
                        <div class="row address-info">
                            ...
                            <div class="col-md-9 address-right text-left">
                                ...
                                <p>Navgujarat Campus, Ashram Road, opp. Gujarat Vidhyapith, Ahmedabad, Gujarat 380014.</p>                            </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 address-grid-w3l">
                        <div class="row address-info">
                            ...
                            <div class="col-md-9 address-right text-left">
                                ...
                                <p>Email :
                                    <a href="#"> mobileservice123@example.com</a>
                                </p>
                            </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3671.443866427226!2d72.5686460143037!3d23.04418322130431!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395e84619d95c129%3A0x96076e0053a43f02!2sNavgujarat%20College%20of%20Computer%20Applications!5e0!3m2!1sen!2sin!4v1679723247628!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
                    <div class="col-md-6 main_grid_login">
                        <div class="form">
                            <h4 class="mb-4 text-left">Send us a message</h4>
                            <form action="#" method="post">
                                <div class="form-group">
                                    <label class="my-2">Name</label>
                                    <input class="form-control" type="text" name="contact_name" placeholder="" required="">
                                </div>
                                <div class="form-group">
                                    <label>Email</label>
                                    <input class="form-control" type="email" name="contact_email" placeholder="" required="">
                                </div>
                                <div class="form-group">
