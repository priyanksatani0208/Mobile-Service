...
<div class="card" >
  <div class="card-body">
  <a href="view_services?btn_view=<?php echo $c ->com_id;?>" class="">
     <img class="card-img-top" src="../admin/company_logo/<?php echo $c ->com_logo;?>" alt="Card image cap"></a>
  </div>
</div>
</div>
<?php
...
<section class="w3l-bottom-grids-6 py-5 text-center">
		<div class="container py-lg-5 py-md-4">
            <h3 class="title-big text-center mb-2">Awesome Web features</h3>
            <!-- <p class="text-head mb-5">Book a free pickup from your home or work at a time slot as per your convenience</p> -->
			<div class="grids-area-hny main-cont-wthree-fea row">
				<div class="col-lg-4 col-md-6 grids-feature">
					<div class="area-box">
						<span class="fa fa-map-marker"></span><br><br>
						<h4>Schedule Pickup</h4><br>
						<p>Book a free pickup from your home or work at a time slot as per your convenience</p><br>
					</div>
				</div>
				<div class="col-lg-4 col-md-6 grids-feature mt-md-0 mt-4">
					<div class="area-box">
						<span class="fa fa-map-marker"></span>
						<h4><a href="#feature" class="title-head">Multiple Service Booking </a></h4>
						<p>Customer can  book  multiple service..</p><br>
					</div>
				</div>
				<div class="col-lg-4 col-md-6 grids-feature mt-lg-0 mt-4">
					<div class="area-box">
						<span class="fa fa-balance-scale"></span>
						<h4><a href="#feature" class="title-head">Resnable price</a></h4>
						<p>customer can choose accoding to their budget.</p>
					</div>
				</div>
				<div class="col-lg-4 col-md-6 grids-feature mt-4 pt-lg-2">
					<div class="area-box">
						...
						<p>Vivamus a ligula quam. Ut blandit eu leo non sed dolor elit sed amet init consec blandit init dolor..</p><br>
					</div>
				</div>
				<div class="col-lg-4 col-md-6 grids-feature mt-4 pt-lg-2">
					<div class="area-box">
						<span class="fa fa-laptop"></span>
						<h4><a href="#feature" class="title-head">Best Prices</a></h4>
						<p>Objective Al-Based Pricing..</p><br><br><br>
					</div>
				</div>
				<div class="col-lg-4 col-md-6 grids-feature mt-4 pt-lg-2">
					<div class="area-box">
						<span class="fa fa-balance-scale"></span>
						<h4><a href="#feature" class="title-head">Free Doorstep </a></h4>
						<p>No fess for pickup phone and services. </p><br><br><br>
					</div>
				</div>
			</div>
		</div>
...
<div class="w3_mg">
<h3>Fast Service</h3>
<p class=" my-lg-4 my-md-3 my-sm-2 my-2">We offer our services in all the major areas and contact us for our onsite mobile services. Our expert engineer will visit your place to get your mobile fixed.</p>
